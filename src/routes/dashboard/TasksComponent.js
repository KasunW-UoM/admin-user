...
const useStyles = createUseStyles((theme) => ({
    ...
    itemTitle: {
        ...
        color: theme.color.veryDarkGrayishGreen
    },
    itemValue: {
        color: theme.color.grayishBlue2
    },
...
function TasksComponent(props) {
    ...
    const [items, setItems] = useState([
        { title: 'Finish order update', checked: false, tag: TAGS.URGENT },
        {
            title: 'Create new order example',
            checked: false,
            tag: TAGS.NEW
        },
        { title: 'Update order report', checked: true, tag: TAGS.DEFAULT }
    ]);
